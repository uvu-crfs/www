...
mysql crfs -e "CREATE TABLE visits(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, group_id INT NOT NULL, start_date BIGINT, end_date BIGINT, days INT, nights INT, students_female INT, students_male INT, advisors INT, evaluation INT, summary INT, darksky INT, notes VARCHAR(255));"
